...
const MainMenu = () => {
  ...
  return (
    <>
      <div className="padding w-full font-poppins py-24 pt-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {menuItems.map((el) => (
            <div
              key={el.id}
              className="bg-white rounded-lg shadow-md p-4 tr hover-card font-montserrat"
              data-aos="zoom-in" 
              data-aos-offset="200" 
            >
              <img
                src={`./img/${el.image}.jpg`}
                alt={`${el.name}`}
        ...
        <div className="flex justify-center pt-6">
          <button className="button bg-orange-400 tr hover:bg-orange-600">
